...
const CinemaPage = () => {
  ...
  useEffect(() => {
    const id = setTimeout(() => {
      ...
      const titles = introCardRef.current.querySelectorAll(".card-title h2");
    ...
    return (
      <div className="relative min-h-screen overflow-hidden">
        ...
        <section className="relative z-10 min-h-screen p-8 flex items-center justify-center">
          ...
          <h1 className="text-9xl font-bold text-white font-[boska]">
            BEAUTY OF CINEMA
          </h1>
  ...
  return (
    <section className="Cinema_page h-full">
      <link
        href="https://api.fontshare.com/v2/css?f[]=zodiak@401&f[]=boska@500&f[]=montserrat@400&f[]=melodrama@500&display=swap"
        rel="stylesheet"
      ></link>
      ...
      <section className="bg-black h-full w-screen text-white ">
        ...
        <div
          ref={cardsRef}
          className="cards relative w-screen bg-[#0f0f0f] text-white flex flex-col gap-[25svh]"
        >
          <div
            ref={introCardRef}
            className="card relative w-full h-svh p-[1.5em]"
          >
            <div className="card-marquee w-full absolute top-1/2 left-0 transform-[translateY(-50%)] overflow-hidden">
              <div className="marquee flex">
                <h3 className="text-[10vw] font-semibold mr-7.5 whitespace-nowrap ">
            ...
            <div className="card-wrapper relative w-full h-full will-change-transform">
              <div className="card-content absolute w-full h-full flex items-end justify-center z-1">
                <div className="card-title w-full absolute top-1/2 left-1/2 transform-[translate(-50%,-50%)] text-center">
                  <h2 className="text-[5rem] font-medium tracking-[-0.1rem] leading-tight font-[dirtyline]">
                    2001 : a space odyssey
                  </h2>
                </div>
                <div className="card-description text-center w-[40%] mb-[3em] relative transform-[translateX(40px)] opacity-0">
                  <p className="text-[1.125rem] font-normal leading-tight">
                    a new perspection
                  </p>
                </div>
              </div>
              <div className="card-img absolute w-full h-full rounded-[150px] overflow-hidden">
                <img
                  className="image_film relative w-full h-full object-cover will-change-transform transform-[scale(2)]"
                  src={"/medias/space_odyssey.webp"}
                ></img>
              </div>
            </div>
          </div>
          <div className="card mt-[50vh] relative w-full h-svh p-[1.5em]">
            <div className="card-marquee w-full absolute top-1/2 left-0 transform-[translateY(-50%)] overflow-hidden"></div>
            <div className="card-wrapper relative w-full h-full will-change-transform">
              <div className="card-content absolute w-full h-full flex items-end justify-center z-1">
                <div className="card-title w-full absolute top-1/2 left-1/2 transform-[translate(-50%,-50%)] text-center">
                  <h2 className="text-[5rem] font-medium tracking-[-0.1rem] leading-tight font-[dirtyline]">
