...
const Skiper99 = () => {
  return (
    <div
      className="bg-muted flex h-full w-full flex-col items-center justify-center">
      ...
      <div
        className="mt-25 flex w-full max-w-3xl flex-wrap items-center justify-center gap-2 px-5 text-justify">
  ...
  return (
    <div
      ...
      <div className="relative grid cursor-pointer items-center justify-center">
        <ChevronRight
          className="transition-all duration-500 ease-out group-hover:translate-x-0.5" />
        <div
          className="absolute right-2.25 h-0.5 w-3 origin-right scale-x-0 rounded-[1px] bg-current transition-all duration-300 ease-out group-hover:right-1.75 group-hover:scale-x-100"></div>
      </div>
    </div>
  );
};

export const MenuIcon = ({ className, onClick, isOpen }) => {
  ...
  return (
    <div
      ...
      <div
        className="relative grid size-4 cursor-pointer items-center justify-center">
        <motion.div
          animate={{ y: isOpen ? 0 : "-5px", rotate: isOpen ? 45 : 0 }}
          className="absolute h-0.5 w-full rounded-full bg-current"></motion.div>
        <motion.div
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="rotate-[-40deg] overflow-hidden">
            <motion.div
              ...
              className="h-4.5 w-fit rounded-full">
              <div
                className="bg-background flex h-full w-[3.5px] items-center justify-center rounded-full">
