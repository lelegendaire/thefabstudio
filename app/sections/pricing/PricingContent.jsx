    ...
    <>
     <h1
      className={`
        ...
        ${
          isFrench
            ? "text-8xl lg:text-8xl md:left-auto lg:left-auto -left-5 md:top-5 lg:top-5 md:rotate-0 lg:rotate-0 rotate-90"
            : "md:text-6xl text-8xl lg:text-8xl md:left-auto lg:left-auto -left-5 md:top-5 lg:top-5 md:rotate-0 lg:rotate-0 rotate-90"
        }
      `}
    > {t("pricing.title")}
      </h1>
      ...
      <div className="bloc flex items-center justify-center md:flex-row lg:flex-row flex-col lg:gap-5 gap-5 md:gap-2 lg:top-30 md:absolute lg:absolute relative text-black">
        ...
        <div className="Starter flex items-center justify-between flex-col h-60 w-70 md:w-60 md:h-40 lg:h-100 lg:w-90 bg-transparent rounded-2xl backdrop-blur-sm backdrop-filter bg-opacity-10 border border-[#ffffff2c] ">
          <div className="head z-2 lg:h-20 w-full flex items-center justify-center">
          ...
          <div className="list z-2 lg:h-60 w-full flex items-center justify-start pt-5 mb-auto flex-col gap-1 lg:gap-5 rounded-b-2xl">
            ...
            <div className="element_list flex justify-start items-center gap-3 w-40 lg:w-60">
              ...
              <div className="name text-xs lg:text-xl">
        ...
        <div className="flex flex-col justify-center items-center gap-5">
        <div className="Signature flex items-center justify-between flex-col h-60 w-70 md:w-60 md:h-40 lg:h-100 lg:w-90 bg-transparent rounded-2xl backdrop-blur-sm backdrop-filter bg-opacity-10 border border-[#ffffff2c] ">
          <div className="head z-2 lg:h-20 w-full flex items-center justify-center">
            <h2 className="font-bold text-xl lg:text-2xl">
        ...
        <div className="flex flex-col justify-center items-center gap-5">
        <div className="Immersive flex items-center justify-between flex-col h-60 w-70 md:w-60 md:h-40 lg:h-100 lg:w-90 bg-transparent rounded-2xl backdrop-blur-sm backdrop-filter bg-opacity-10 border border-[#ffffff2c] ">
          <div className="head z-2 lg:h-20 w-full flex items-center justify-center">
            <h2 className="font-bold text-xl lg:text-2xl text-nowrap">
